...
public interface CurriculumService {
	...
	Response noteFacultyCoursesChanged(String facultyName, String degreeName, FacultyCourseChangeType changeType, Integer courseId, String courseName, Integer courseCredits);
}
